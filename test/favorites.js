...
describe('Favorites: A user', function () {
    ...
    it('should be able to favorite a track (put: /favorites/:track_id)', function (done) {
        agent.bob
    ...
    it('should be able to get her favorite tracks (get: /favorites)', function (done) {
        agent.bob
            .get('/favorites')
    ...
    it('should be able to unfavorite a track (delete: /favorites/:track_id)', function (done) {
        agent.bob
    ...
    it('should not be able to favorite a non-existent track (put: /favorites/:track_id)', function (done) {
        agent.bob
            .put('/favorites/' + 0)
    ...
    it('should not be able to unfavorite a non-existent track (put: /favorites/:track_id)', function (done) {
        agent.bob
            .delete('favorites/' + 0)
            .expect(StatusTypes.notFound, done);
    });
    ...
    it('should not be able to favorite a track if not logged in (put: /favorites/:track_id)', function (done) {
        agent.cow
            .put('/favorites/' + track_ids.dolan[0])
    ...
    it('should not be able to get her favorite tracks if not logged in (get: /favorites)', function (done) {
        agent.cow
            .get('/favorites')
            .expect(StatusTypes.unauthorized, done);
    });
    ...
    it('should not be able to unfavorite a track if not logged in (delete: /favorites/:track_id)', function (done) {
        agent.cow
            .delete('/favorites/' + track_ids.dolan[0])
            .expect(StatusTypes.unauthorized, done);
    });
